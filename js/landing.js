...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('EBULLIENCE | 2k17 | '+getTimeRemaining(deadline).days+' '+day+' | '+getTimeRemaining(deadline).hours+' '+hour+' | '+getTimeRemaining(deadline).minutes+' '+minute+' | LOGIN NOW ');
    }
